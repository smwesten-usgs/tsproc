...
::
:: C:\Program Files (x86)\Intel\Composer XE 2011 SP1\bin\ipsxe-comp-vars.bat" intel64 vs2010"
::
...
set FC=ifort.exe
set CC="%VCINSTALLDIR%\bin\x86_amd64\cl.exe"
set CXX="%VCINSTALLDIR%\bin\x86_amd64\cl.exe"
::
